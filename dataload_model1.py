...
def input_get(target_index,num_index,file_path,velocity,winkel):
    lr = 1.25
    l = 2 * lr
    with open(file_path, 'rb') as fp:
        data = pickle.load(fp)
...
def train_valid_get():
    ...
    target_data, target_index, num_index, velocity, winkel = target_get('allAmsterdamerRing.pickle')
