...
class Decoder_lstm(tf.keras.Model):
    ...
    def call(self, x, hidden, cell, hidden_1,cell_1, enc_output,mode):
        ...
        output, state, cell_state = self.lstm(concat_vector, initial_state=[hidden,cell])

        output_1,state_1,cell_state_1 = self.lstm_1(output,initial_state=[hidden_1,cell_1])
        ...
        return results,state,cell_state,state_1,cell_state_1
