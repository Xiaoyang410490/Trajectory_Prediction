...
def geo_rechnen(lane,lane2,lane3,laneid,laneid_2,laneid3,posx,posy,mapgeometry):
    ...
    kappa_5, ori_5, rul_5 = future_parameter(5,mapgeometry,posx,posy,laneid,laneid_2,laneid3,lane,lane2,lane3)
    kappa_10, ori_10, rul_10 = future_parameter(10,mapgeometry,posx,posy,laneid,laneid_2,laneid3,lane,lane2,lane3)
    kappa_15, ori_15, rul_15 = future_parameter(15, mapgeometry, posx, posy, laneid,laneid_2,laneid3, lane,lane2,lane3)

    return width,kappa,orien,rul,kappa_5,ori_5,rul_5,kappa_10,ori_10,rul_10,kappa_15,ori_15,rul_15
...
def findlane_index(pos_x,pos_y,kind,num):
    ...
    for i in range(len(list1)):
        ...
        width, kappa, orien, rul_, kappa_5, ori_5, rul_5, kappa_10, ori_10, rul_10, kappa_15, ori_15, rul_15 = geo_rechnen(lane, lane2, lane3, id_1, id_2,id_3, pos_x[i], pos_y[i],mapgeometry)
