...
#to get the lanelet of initial point
...
def findlane_index(pos_x,pos_y,kind):
    ...
    #distinguish the manuever of the lanelet
    while (dist < dis):
        num = num + 1
    ...
    for i in range(len(list1)):
        ...
        for k in range(len(list0)):
            if list0[k] == list1[i] and k != (len(list0)-1):
                id_2 = list0[k+1]
            elif list0[k] == list1[i] and k == (len(list0)-1):
                id_2 = list0[k]
        lane2 = map.laneletLayer[id_2]
        list2.append(id_2)

        for k in range(len(list0)):
            if list0[k] == list1[i] and k < (len(list0)-2):
                id_3 = list0[k+2]
            elif list0[k] == list1[i] and k >= (len(list0)-2):
                id_3 = list0[k]
        lane3 = map.laneletLayer[id_3]
        list3.append(id_3)

        width, kappa, orien, rul_, kappa_5, ori_5, rul_5, fai_5, kappa_10, ori_10, rul_10, fai_10, kappa_15, ori_15, rul_15, fai_15 = geo_rechnen(lane, lane2,lane3, list1[i], id_2,id_3, pos_x[i], pos_y[i],mapgeometry)
