...
def geo_rechnen(laneid,lane,posx,posy):
    ...
    return dis_to_center,kappa, fai
...
def findlane_index(pos_x,pos_y):
    ...
    for i in range(len(list1)):
        ...
        dis_, kru_,fai_ = geo_rechnen(list1[i], lanelet_layer, pos_x[i], pos_y[i])
        dis.append(dis_)
        kru.append(kru_)
        fai.append(fai_)

    return rul,dis,kru,fai
