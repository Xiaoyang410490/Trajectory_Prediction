...
#get the lanelet of the initial point
def find_lane1(xf,yf,x,y,map,mapgeometry):
    ...
    if len(lanelets) == 1:
        ...
        # there is only one lanelet,especially in the area before the intersection, that lanelet is the one we need
        lane = lanelets[0]
...
# Map to the lanelet of the other points
