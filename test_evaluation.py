...
def train_step(input,target,dec_in):
    ...
    with tf.GradientTape() as tape:
        ...
        for t in range(15):
            ...
            predictions, dec_hidden, _ = decoder(dec_input, dec_hidden, enc_output, 'train')
...
def test_set():
    ...
    dataset_valid = tf.data.Dataset.from_tensor_slices((x_valid, y_valid)).shuffle(len(x_valid))
    ...
    for i in range(Nummer):
        ...
        for t in range(30, 135):
            ...
            for ind in range(15):
                ...
                predictions, dec_hidden, _ = decoder(dec_input, dec_hidden, enc_out, 'test')
