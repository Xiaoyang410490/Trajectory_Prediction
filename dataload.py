...
def target_input_get(fp1):
    ...
    for i in range(len(data)):
        ...
        pos_x, pos_y = cuvre_filter(pos_x, pos_y)
...
def train_valid_get():
    ...
    right = [11,12,19,34,35,47,48,49,50,54,65,66,70,80,81,82,84,85,87,90,91,93,98,99,104,105,106,123,124,126,130,131,132,
             133,134,135,136,137,138,139,140,141,142,143,144,145,146,147,148,158,159,162,163,165,166,167,168,170,171,172,173,
             174,175,176,177,178,179,180,181,187,196,197,198,199,200,201,202,204,205,209,210,211,212,213,214,215,216,217,218,219,
             220,223,231,232,233,234,235,236,237,241,249,250,252,253,256,257,258,259,262,263,264,275,276,277,278,279,290,291,292,293,
             297,298,299,300,307,319,320,321,322,323,324,325,326,331,332,333,334,339,352,353,354,355,357,362,363,364,365,366,378,379,380,
             381,382,383,384,385,386,393,394,439,442,443,474,477,485,486,487,490,498,499,500,501,503,504,506,507,508,509,513,514,515,516,
             519,527,528,529,530,532,533,534,536,537,538,543,559,563,576,582,606,618,619,620,621,624,627,628,629,630,653,654,655,656,657,
             659,660,661,662,663,664]

    left = [0,1,4,5,6,7,18,19,21,22,23,24,25,26,27,28,31,32,33,34,35,54,61,62,63,64,90,94,99,105,106,107,108,109,110,
            113,114,116,117,121,122,124,125,126,128,129,130,131,132,133,137,138,139,140,144,145,147,148,149,151,152,153,154,
            161,174,175,178,179,180,184,185,186,187,188,197,217,224,225,226,227,228,229,230,231,236,237,238,239,241,245,249,250,
            253,262,263,267,268,269,274,275,276,277,278,280,281,282,283,295,304,305,306,307,312,315,316,317,318,319,334,335,336,
            340,341,342,343,348,349,350,351,353,354,371,372,377,393,394,395,396,423,424,425,430,447,448,49,450,453,455,456,457,458,
            459,467,469,470,471,472,475,476,477,478,484,485,486,488,497,498,499,503,510,531,532,574,574,576,577,578,579]
    ...
    for i in range(test_split,len(input_data)):
...
def check_data_2():
    ...
    for i in range(len(target_data_l)):
        ...
        for t in range(len(training_d)):
            ...
            ang.append(targte_per_time[0]/10)
            acc.append(targte_per_time[1]/100)
