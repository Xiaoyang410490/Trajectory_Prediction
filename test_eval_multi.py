...
def train_step(input,target,dec_in):
    ...
    with tf.GradientTape() as tape:
        ...
        for t in range(15):
            ...
            predictions, dec_hidden, dec_cell,dec_hidden_1,dec_cell_1 = decoder(dec_input, dec_hidden, dec_cell, dec_hidden_1, dec_cell_1, enc_output,'train')
    ...
    for i in range(Nummer):
        ...
        for t in range(30, 135):
            ...
            for ind in range(15):
                ...
                predictions, dec_hidden, dec_cell, hidden_1, cell_1 = decoder(dec_input, dec_hidden, dec_cell, hidden_1, cell_1, enc_out,'test')
...
#set the checkpoint
checkpoint_dir = './multi_lstm_checkpoints'
